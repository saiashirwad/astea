/**
 * PROTOTYPE — scoped authority seam around TypeScript 7's native async client.
 *
 * This is an experiment, not the proposed public project-transformation API.
 */
...
export class NativeCompiler extends Context.Service<NativeCompiler, NativeCompilerService>()(
  "@teatime/prototype/NativeCompiler",
) {}
